...
public class Welcome02_Object {
   public static void main(String[] args) {
      ...
      if (ob1.colderThan(ob2) && ob1.colderThan(ob3)) {
         System.out.println("Colder at " + id1 + " (Atlanta, Hartsfield-Jackson Atlanta International Airport)");
      } else if (ob2.colderThan(ob1) && ob2.colderThan(ob3)) {
         System.out.println("Colder at " + id2 + " (Savannah, Savannah/Hilton Head International Airport)");
      } else {
         System.out.println("Colder at " + id3 + " (Grand Prairie, Grand Prairie Municipal Airport)");
      }
   }
}
